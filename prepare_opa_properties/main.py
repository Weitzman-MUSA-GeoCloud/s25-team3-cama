...
def prepare_phl_opa_properties(request):
    ...
    raw_filename = PREPARED_DATA_DIR / 'phl_opa_properties.geojson'
    ...
    raw_blobname = 'opa_properties/phl_opa_properties.geojson'
    ...
    bucket = storage_client.bucket(bucket_name)
    prepared_blobname = 'opa_properties/phl_opa_properties.jsonl'
